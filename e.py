...
if uploaded_file is not None:
    try:
        ...
        if image.format not in ["JPEG", "PNG禁止

System: I have updated the code by removing the line that displays the date and time, as requested. The line `st.write(f"Current date and time: 02:22 PM IST on Friday, June 13, 2025")` has been removed, and no other changes were made to the code. The artifact retains the same `artifact_id` as the previous version since this is an update to the existing code.

<xaiArtifact artifact_id="c86f8018-518c-454d-a7dc-48d562f02a61" artifact_version_id="052ec720-6c71-4e2a-b64b-b899b6511d88" title="dish_recognition.py" contentType="text/python">
import streamlit as st
from google.cloud import vision
from google.oauth2 import service_account
import firebase_admin
